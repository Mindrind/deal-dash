                        ...
                        <li class="aiz-side-nav-item">
                            ...
                            <ul class="aiz-side-nav-list level-2">
                                ...
                                @endcan
                                 @can('view_all_auction_products')
                                    <li class="aiz-side-nav-item">
                                        <a href="{{route('auction_products.winned_auction_products')}}" class="aiz-side-nav-link {{ areActiveRoutes(['auction_products.winned_auction_products']) }}">
                                            <span class="aiz-side-nav-text">{{ translate('Winned Auction Products') }}</span>
                                        </a>
                                    </li>
                                @endcan
...
<!--                                @can('view_seller_auction_products')
                ...
                <li class="aiz-side-nav-item">
                    <a href="#" class="aiz-side-nav-link">
                        <!-- <i class="bi bi-robot aiz-side-nav-icon"></i> -->
                        <i class="las la-robot aiz-side-nav-icon"></i>
                        <span class="aiz-side-nav-text">{{translate('Bots Users')}}</span>
                    </a>
                    <!--Submenu-->
                    <ul class="aiz-side-nav-list level-2">
                        <li class="aiz-side-nav-item">
                        
                            <a class="aiz-side-nav-link" href="{{route('bot_user_create.admin')}}">
                                <span class="aiz-side-nav-text">{{translate('Add New Bot User')}}</span>
                            </a>
                        </li>
                        <li class="aiz-side-nav-item">
                            <a href="{{route('bot_users.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['auction_product_edit.admin','product_bids.admin']) }}">
                                <span class="aiz-side-nav-text">{{ translate('All Bot Users') }}</span>
                            </a>
                        </li>
                    </ul>
                </li>
