                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="number" lang="en" min="0" placeholder="{{ translate('Price') }}" name="unit_price" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Reserved price')}} <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input type="number" lang="en" placeholder="{{ translate('Resesrved price') }}" name="reserved_price" class="form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
	                        ...
	                        <label class="col-sm-3 control-label" for="start_date">{{translate('Auction Start Date')}}</label>
	                        <div class="col-sm-9">
	                          ...
	                          <input type="text" class="form-control select-date" name="auction_date_range" data-format="DD-MM-Y HH:mm:ss"  placeholder="{{translate('Select Date')}}"  autocomplete="off">
	                        </div>
	                    </div>
                    </div>
                </div>
