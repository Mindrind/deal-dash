...
<div class="">
    ...
    action="/admin/auction_products/update/{{$product->id}}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        @php
                          ...
                          $start_date = date('m-d-Y H:i:s', $product->auction_start_date);
                        ...
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Reserved price')}} <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input type="number" lang="en" placeholder="{{ translate('Resesrved price') }}" name="reserved_price" class="form-control" value="{{$product->reserved_price}}" required>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{translate('Starting Bidding Price')}} <span class="text-danger">*</span></label>
                            <div class="col-md-9">
                                <input type="number" lang="en" min="0" step="0.01" placeholder="{{ translate('Starting bidding price') }}" name="starting_bid" class="form-control" required value="{{$product->starting_bid}}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            <label class="col-sm-3 col-from-label" for="start_date">{{translate('Auction Start Date')}}</label>
                            <div class="col-sm-9">
                                ...
                                <input type="text" class="form-control select-date" value="{{ $start_date }}" name="auction_date_range" placeholder="{{translate('Select Date')}}" data-time-picker="true" data-format="MM-DD-Y HH:mm:ss" autocomplete="off">
                            </div>
                        </div>
                    </div>
                </div>
