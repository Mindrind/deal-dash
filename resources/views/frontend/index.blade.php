...
@section('content')
    ...
    <div id="section_won_auctions">
        @if (count($auction_won_products) > 0)
                <section class="mb-4">
                    <div class="container">
                        <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                            ...
                            <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true'>
                                @foreach ($auction_won_products as $key => $new_auction_product)
                                <div class="carousel-box">
                                    @include('frontend.partials.product_auction_box_1',['product' => $new_auction_product])
                                </div>
                                @endforeach
                            </div>
                        </div>
    ...
    <div id="section_auction_products">
                ...
                <div class="container">
                    <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                            <h3 class="h5 fw-700 mb-0">
                                <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">
                                    {{ translate('Upcoming Auctions') }}
                                </span>
                            </h3>
                        </div>
                        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true'>
                            @foreach ($auction_products as $key => $new_auction_product)
                            <div class="carousel-box">
                                @include('frontend.partials.product_auction_box_1',['product' => $new_auction_product])
                            </div>
                            @endforeach
    ...
    <div id="section_auction_products">
        @if (count($winned_auction_products) > 0)
            <section class="mb-4">
                <div class="container">
                    <div class="px-2 py-4 px-md-4 py-md-3 bg-white shadow-sm rounded">
                        <div class="d-flex mb-3 align-items-baseline border-bottom">
                            <h3 class="h5 fw-700 mb-0">
                                <span class="border-bottom border-primary border-width-2 pb-3 d-inline-block">
                                    {{ translate('Winned Auction Product') }}
                                </span>
                            </h3>
                        </div>
                        <div class="aiz-carousel gutters-10 half-outside-arrow" data-items="6" data-xl-items="5" data-lg-items="4"  data-md-items="3" data-sm-items="2" data-xs-items="2" data-arrows='true'>
                            @foreach ($winned_auction_products as $key => $new_auction_product)
                            <div class="carousel-box">
                                @include('frontend.partials.product_winned_auction_box',['product' => $new_auction_product])
                            </div>
                            @endforeach
                        </div>
                    </div>
    ...
    <script>
        $(document).ready(function(){
            ...
            $.post('{{ route('home.section.auction_products') }}', {_token:'{{ csrf_token() }}'}, function(data){
                ...
                if(!data.includes("Login to your account.")){
